...
public class Frontend implements FrontendInterface {
        ...
        while (!exit) {
            ...
            switch (choice) {
                case 1:
                  ...
                  break;
                case 2:
                    Iterator<IngredientInterface> replacements = listReplacements();
                    if(replacements != null){
                        while(replacements.hasNext()){
                            IngredientInterface ingredient = replacements.next();
    ...
    public Iterator<IngredientInterface> listReplacements(){
        ...
        try{
          ...
          Iterator<IngredientInterface> iterator = replacements.iterator();
          return iterator;
