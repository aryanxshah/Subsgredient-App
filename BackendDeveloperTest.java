...
public class BackendDeveloperTest {
    ...
    public void testReadData1() throws IOException {
        // Specify the path to a valid CSV file containing Ingredient data
...
//SEE THE CODE HERE
        // Assert that the data is not null and that there are 600 Ingredients in the list as well as 1
        // column name row
//        Assertions.assertEquals(600, rbt.size());
    ...
    public void testGetReplacements2() throws FileNotFoundException {
        ...
        IterableMultiKeyRBT<T> rbt = new IterableMultiKeyRBT<>();
     ...
     * store all the Ingredients is correctly reported by the numKeys() method or
    ...
    public void testReplacementsIntegration() throws FileNotFoundException { //to check if ingredient entered is null
        ...
        Iterator<T> replacements = frontendInterface.replacements(ingredient);
