...
public class BinarySearchTree<T extends Comparable<T>> {
    ...
    protected void rotate(Node<T> child, Node<T> parent) throws IllegalArgumentException {
        ...
        if (child == parent.down[0]) {
            ...
            throw new IllegalArgumentException("no relation between parent and child");
        }
    }
    ...
    public static boolean test1() {
        ...
        Integer root = 50;
        Integer leftChild = 45;
        Integer subLeftChild = 47;
        Integer gLeftChild = 40;
        Integer subgRightChild = 42;
        Integer subgLeftChild = 35;
        bst1.insert(root);
        bst1.insert(leftChild);
        bst1.insert(subLeftChild);
        bst1.insert(gLeftChild);
        bst1.insert(subgRightChild);
        bst1.insert(subgLeftChild);
        bst1.rotate(bst1.root.down[0].down[0], bst1.root.down[0]);
        String actual = bst1.toInOrderString();
        String expected = "[ 35, 40, 42, 45, 47, 50 ]";
    ...
    public static boolean test2() {
        ...
        Integer proot = 50;
        Integer rightChild = 60;
        Integer subRightChild = 52;
        Integer gRightChild = 70;
        Integer subgRightChild1 = 75;
        Integer subgLeftChild1 = 65;
        bst2.insert(proot);
        bst2.insert(rightChild);
        bst2.insert(subRightChild);
        bst2.insert(gRightChild);
        bst2.insert(subgRightChild1);
        bst2.insert(subgLeftChild1);

        bst2.rotate(bst2.root.down[1].down[1], bst2.root.down[1]);
        String actual1 = bst2.toInOrderString();
        String expected1 = "[ 50, 52, 60, 65, 70, 75 ]";
    ...
    public static boolean test3() {
        ...
        bst2.rotate(bst2.root.down[1], bst2.root);
        String actual1 = bst2.toInOrderString();
        String expected1 = "[ 40, 50, 52, 60, 65, 70, 75 ]";
        if (!actual1.equals(expected1)){
            return false;
        }
        return true;
